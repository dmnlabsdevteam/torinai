...
# LocalAuthentication refuses to evaluate a policy for an unsigned bundle, so
# ad-hoc signing is required, not cosmetic. Touch ID simply never prompts without it.
